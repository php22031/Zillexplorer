...
$(document).ready(function(){
  ...
  function setHeights() {
    windowHeight = $(window).innerHeight() - 136; // Minus footer area height
    $('#main-content').css('min-height', windowHeight);
    
    //console.log("windowHeight = " + windowHeight);
    
    //table_height = $('table#stats_table_1').innerHeight();
    //$('table#stats_table_2').attr('height', table_height + 2);
